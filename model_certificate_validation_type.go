...
const (
	ENABLED CertificateValidationType = "enabled"
	DISABLED_FOR_LOCAL_ADDRESSES CertificateValidationType = "disabledForLocalAddresses"
	DISABLED CertificateValidationType = "disabled"
)
