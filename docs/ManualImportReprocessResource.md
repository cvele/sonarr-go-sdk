...
`func (o *ManualImportReprocessResource) GetLanguage() Language`

GetLanguage returns the Language field if non-nil, zero value otherwise.

### GetLanguageOk

`func (o *ManualImportReprocessResource) GetLanguageOk() (*Language, bool)`
...
`func (o *ManualImportReprocessResource) SetLanguage(v Language)`

SetLanguage sets Language field to given value.

### HasLanguage

`func (o *ManualImportReprocessResource) HasLanguage() bool`
